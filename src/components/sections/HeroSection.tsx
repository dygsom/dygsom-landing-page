...
export const HeroSection: React.FC = () => {
  return (
    <section 
      className="relative min-h-[70vh] md:h-[80vh] flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-dygsom-dark to-slate-950"
      itemScope 
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl px-4 md:px-6 animate-fade-in">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-dygsom-light-text mb-4 md:mb-6" itemProp="name">
          Plataforma antifraude para <span className="text-dygsom-blue">e-commerce y fintech</span>
        </h1>
        <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-6 md:mb-8 px-2 max-w-3xl mx-auto" itemProp="description">
